...
export class OpenAI extends Core.APIClient {
     ...
     */
    constructor({ baseURL = Core.readEnv('OPENAI_BASE_URL'), apiKey = "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", organization = Core.readEnv('OPENAI_ORG_ID') ?? null, ...opts } = {}) {
        if (apiKey === undefined) {
